    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-12 mb-4">
            <div class="card shadow-lg border-light rounded">
                ...
                <div class="card-body text-center">
                    <h2 class="display-5 font-weight-bold">150</h2>
        ...
        <div class="col-lg-3 col-12 mb-4">
            <div class="card shadow-lg border-light rounded">
                ...
                <div class="card-body text-center">
                    <h2 class="display-5 font-weight-bold">{{ $userCount }}</h2>
                    <p class="text-muted">New users</p>
                </div>
                <div class="card-footer bg-light text-center">
                    <a href="{{ route('plant-user.index') }}" class="btn btn-link">View Details</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-12 mb-4">
            <div class="card shadow-lg border-light rounded">
                ...
                <div class="card-body text-center">
                    <h2 class="display-5 font-weight-bold">{{ $customerCount }}</h2>
                    <p class="text-muted">New customers</p>
                </div>
                <div class="card-footer bg-light text-center">
                    <a href="{{ route('customers.index') }}" class="btn btn-link">View Details</a>
                </div>
            </div>
        </div>
